  ...
  return (
    <div className="skills_list-wrapper">
      <div className="skills_list">
        ...
        <i className="fa-brands fa-npm fa-2xl"></i>
        <i className="fa-brands fa-github fa-2xl"></i>
        <i className="fa-brands fa-css3-alt fa-2xl"></i>
        <i className="fa-brands fa-sass fa-2xl"></i>
        {/* <i className="fa-sharp fa-regular fa-code-branch fa-2xl"></i> */}
        {/* <i className="fa-regular fa-code-pull-request fa-2xl"></i>
        <i className="fa-regular fa-brackets-curly fa-2xl"></i>
        <i className="fa-regular fa-webhook fa-2xl"></i> */}
        {/* <i className="fa-sharp fa-light fa-window fa-2xl"></i> */}
        <i className="fa-brands fa-git fa-2xl"></i>
        <i className="fa-brands fa-react fa-2xl"></i>
        <i className="fa-brands fa-square-js fa-2xl"></i>
        {/* <i className="fa-brands fa-atlassian fa-2xl"></i> */}
        ...
        <i className="fa-brands fa-chrome fa-2xl"></i>
