  ...
  return (
    <div className="projects-grid">
      <ProjectCard
        ...
        description="Optimised the website of MGemi"
      ...
      <ProjectCard
        name="Aventon"
        description="Pixel Perfected the Aventon website"
      ...
      <ProjectCard
        name="Glyde Rides"
        description="https://i.imgur.com/ETnn8zX.png?1"
      ...
      <ProjectCard
        name="Blurry Loading"
        description="A blurry loading webpage"
      ...
      <ProjectCard
        ...
        description="A minimal JavaScript Carousel"
      ...
      <ProjectCard
        name="React Carousel"
        description="A minimal React Carousel"
      ...
      <ProjectCard
        name="Keeper"
        description="Clone of Google Keep web app"
      ...
      <ProjectCard
        name="Simon Game"
        description="Simon- A Memory Game"
